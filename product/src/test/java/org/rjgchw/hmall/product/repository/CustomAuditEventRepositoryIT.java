...
import org.rjgchw.hmall.product.config.audit.AuditEventConverter;
import org.rjgchw.hmall.product.domain.PersistentAuditEvent;
...
import static org.rjgchw.hmall.product.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
