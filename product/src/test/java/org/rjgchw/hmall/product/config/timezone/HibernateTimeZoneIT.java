package org.rjgchw.hmall.product.config.timezone;
...
import org.rjgchw.hmall.product.repository.timezone.DateTimeWrapper;
import org.rjgchw.hmall.product.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM hh_date_time_wrapper where id=%d", fieldName, id);
    }
